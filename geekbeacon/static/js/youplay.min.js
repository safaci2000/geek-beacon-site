...
function initNavbar() {
    var self = this;
    var socialHeader = document.querySelector('.header-top')
    

    self.socialHeight = socialHeader.getBoundingClientRect().height;

    self.getSocialHeight = function () {
        self.socialHeight = socialHeader.getBoundingClientRect().height
    }

    // navbar size
    self.navbarSize = function (curTop) {
        // console.log('log curTop:', curTop)
        self.getSocialHeight()
        if (curTop > 0 && !this.navbarSmall) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=youplay.min.js.map
